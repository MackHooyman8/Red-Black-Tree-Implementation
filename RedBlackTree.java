...
public class RedBlackTree<T extends Comparable<T>> {
    ...
    private void insertHelper(Node<T> newNode, Node<T> subtree) {
        ...
        if(!newNode.isBlack) enforceRBTreePropertiesAfterInsert(newNode);
    }
    ...
    /**
     * Enforces the properties of a RBT after an insertion
     * @param child
     */
    private void enforceRBTreePropertiesAfterInsert(Node<T> child) {
    	
    	while((child.parent != null) && (!child.parent.isBlack)) {
    		
    		Node<T> gParent = child.parent.parent;
    		Node<T> parent = child.parent;
    		
    		if(parent.equals(gParent.leftChild)) {
    			
    			if((gParent.rightChild != null) && (!gParent.rightChild.isBlack)) {
    				
    				gParent.rightChild.isBlack = true;
    		...
    		else if(parent.equals(gParent.rightChild)) {
    			
    			if((gParent.leftChild != null) && (!gParent.leftChild.isBlack)) {
    				
    				gParent.leftChild.isBlack = true;
    				gParent.isBlack = false;
    				parent.isBlack = true;
    				child = gParent;
